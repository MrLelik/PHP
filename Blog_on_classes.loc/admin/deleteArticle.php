...
?>
<?php
if (isset($_GET['deleteUrl']) && ! empty($_GET['deleteUrl'])) {
	$articleManager->deleteArticle($_GET['deleteUrl']);
	unset($_GET['id']);
            ...
            <div class="list-group list-group-flush small">
				...
				<?php if ($articles): ?>
					<?php foreach ($articles as $article): ?>
						<?php $author
							= $articleManager->getAuthor($article->author); ?>
                        ...
                        <a class="btn btn-warning" href="deleteArticle.php?deleteUrl=<?= $article->url; ?>">Delete</a>
					<?php endforeach; ?>
				<?php else: ?>
